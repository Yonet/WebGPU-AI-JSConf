...
export class App {
    ...
    private translationLanguage: string = 'it';
    private translatedText: string = '';
    private translationTime: number | null = null;
    private localTranslationLanguage: string = 'it';
    ...
    private onWorkerMessage ( data: WorkerMessageEvent ): void {
        switch ( data.status ) {
            ...
            case 'translator-ready':
                ...
                this.localTranslationDisplay.textContent = '';
                if ( this.text ) {
                    this.translateTextLocal();
                } else {
                    this.localTranslationDisplay.textContent = 'Ready for translation';
                }
                break;
